...
<div class="vamtam-tabbed">
	...
	<ul class="vamtam-tabs">
		<li class="vamtam-tab"><label for="login-tab"><?php esc_html_e( 'Sign In', 'woocommerce' ); ?></label></li>
		<li class="vamtam-tab"><label for="register-tab"><?php esc_html_e( 'Register', 'woocommerce' ); ?></label></li>
	</ul>
	<div class="vamtam-tab-content u-columns col2-set" id="customer_login">
		...
		<?php endif; ?>
				...
				<h5><?php esc_html_e( 'Welcome Back', 'innovecouture' ); ?></h5>
				<h6><?php esc_html_e( 'Please sign in to access your full account', 'innovecouture' ); ?></h6>
				...
				<form class="woocommerce-form woocommerce-form-login login" method="post">
					...
					<p class="form-row">
						<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
							<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'innovecouture' ); ?></span>
						</label>
						<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
						<button type="submit" class="woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Sign In', 'innovecouture' ); ?>"><?php esc_html_e( 'Sign In', 'innovecouture' ); ?></button>
					</p>
					<p class="woocommerce-LostPassword lost_password">
						<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'innovecouture' ); ?></a>
					</p>
		...
		<div class="u-column2 col-2">
			...
			<h5><?php esc_html_e( 'Create Account', 'innovecouture' ); ?></h5>
