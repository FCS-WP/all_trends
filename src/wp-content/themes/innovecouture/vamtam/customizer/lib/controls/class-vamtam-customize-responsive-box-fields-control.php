...
class Vamtam_Customize_Responsive_Box_Fields_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'top'       => esc_html__( 'Top', 'innovecouture' ),
			'right'     => esc_html__( 'Right', 'innovecouture' ),
			'bottom'    => esc_html__( 'Bottom', 'innovecouture' ),
			'left'      => esc_html__( 'Left', 'innovecouture' ),
			'padding'   => esc_html__( 'Padding', 'innovecouture' ),
		);
	}
	/**
