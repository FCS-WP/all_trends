...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'innovecouture' ),
			'change'       => esc_html__( 'Change Image', 'innovecouture' ),
			'remove'       => esc_html__( 'Remove', 'innovecouture' ),
			'default'      => esc_html__( 'Default', 'innovecouture' ),
			'placeholder'  => esc_html__( 'No image selected', 'innovecouture' ),
			'frame_title'  => esc_html__( 'Select Image', 'innovecouture' ),
			'frame_button' => esc_html__( 'Choose Image', 'innovecouture' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'innovecouture' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'innovecouture' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'innovecouture' ),
				'repeat'    => esc_html__( 'Repeat both', 'innovecouture' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'innovecouture' ),
				'fixed'  => esc_html__( 'fixed', 'innovecouture' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'innovecouture' ),
				'cover'   => esc_html__( 'cover', 'innovecouture' ),
				'contain' => esc_html__( 'contain', 'innovecouture' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'innovecouture' ),
				'left center'   => esc_html__( 'left center', 'innovecouture' ),
				'left bottom'   => esc_html__( 'left bottom', 'innovecouture' ),
				'center top'    => esc_html__( 'center top', 'innovecouture' ),
				'center center' => esc_html__( 'center center', 'innovecouture' ),
				'center bottom' => esc_html__( 'center bottom', 'innovecouture' ),
				'right top'     => esc_html__( 'right top', 'innovecouture' ),
				'right center'  => esc_html__( 'right center', 'innovecouture' ),
				'right bottom'  => esc_html__( 'right bottom', 'innovecouture' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'innovecouture' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'innovecouture' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'innovecouture' ),
			'background-repeat'     => esc_html__( 'Repeat', 'innovecouture' ),
			'background-image'      => esc_html__( 'Image', 'innovecouture' ),
			'background-attachment' => esc_html__( 'Attachment', 'innovecouture' ),
			'background-size'       => esc_html__( 'Size', 'innovecouture' ),
			'background-position'   => esc_html__( 'Position', 'innovecouture' ),
			'background-color'      => esc_html__( 'Color', 'innovecouture' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'innovecouture' ),
				'color-2'              => esc_html__( 'Color 2', 'innovecouture' ),
				'location'             => esc_html__( 'Location', 'innovecouture' ),
				'type'                 => esc_html__( 'Type', 'innovecouture' ),
				'position'             => esc_html__( 'Position', 'innovecouture' ),
				'angle'                => esc_html__( 'Angle', 'innovecouture' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'innovecouture' ),
					'radial' => esc_html__( 'Radial', 'innovecouture' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'innovecouture' ),
					'center left'   =>  esc_html__( 'Center Left' , 'innovecouture' ),
					'center right'  =>  esc_html__( 'Center Right' , 'innovecouture' ),
					'top center'    =>  esc_html__( 'Top Center' , 'innovecouture' ),
					'top left'      =>  esc_html__( 'Top Left' , 'innovecouture' ),
					'top right'     =>  esc_html__( 'Top Right' , 'innovecouture' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'innovecouture' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'innovecouture' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'innovecouture' ),
				],
			],
		);
