...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'innovecouture' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'innovecouture' ),
			'font-weight'                     => esc_html__( 'Weight', 'innovecouture' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'innovecouture' ),
				'uppercase'    => esc_html__( 'Uppercase', 'innovecouture' ),
				'lowercase'    => esc_html__( 'Lowercase', 'innovecouture' ),
				'capitalize'   => esc_html__( 'Capitalize', 'innovecouture' ),
				'normal'       => esc_html__( 'Normal', 'innovecouture' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'innovecouture' ),
				'normal'       => esc_html__( 'Normal', 'innovecouture' ),
				'italic'       => esc_html__( 'Italic', 'innovecouture' ),
				'oblique'      => esc_html__( 'Oblique', 'innovecouture' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'innovecouture' ),
				'underline'    => esc_html__( 'Underline', 'innovecouture' ),
				'overline'     => esc_html__( 'Overline', 'innovecouture' ),
				'line-through' => esc_html__( 'Line Through', 'innovecouture' ),
				'none'         => esc_html__( 'None', 'innovecouture' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'innovecouture' ),
			'line-height'                => esc_html__( 'Line Height', 'innovecouture' ),
			'color'                      => esc_html__( 'Font Color', 'innovecouture' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'innovecouture' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'innovecouture' ), [ 'code' => [] ] ),
		);
	}
	/**
