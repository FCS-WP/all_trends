	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'innovecouture' ),
				'iconName'   => esc_html__( 'Icon', 'innovecouture' ),
				'iconText'   => esc_html__( 'Text', 'innovecouture' ),
				'iconLink'   => esc_html__( 'Link', 'innovecouture' ),
				'iconChange' => esc_html__( 'Change', 'innovecouture' ),
				'fonts'      => $GLOBALS['vamtam_fonts'],
				'home_url'   => home_url(),
				'elementsTxt' => esc_html__( 'Enter your Envato Elements Token.', 'innovecouture' ),
				'tfPcTxt' => esc_html__( 'Enter your purchase code from ThemeForest to receive theme updates and support.', 'innovecouture' ),
				'unRegPcTxt' => esc_html__( 'You are about to unregister your purchase code. Are you sure you want to continue?', 'innovecouture' ),
				'unRegTokenTxt' => esc_html__( 'You are about to unregister your Envato Elements Token. Are you sure you want to continue?', 'innovecouture' ),
