...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     => esc_html__( 'Advanced AJAX Product Filters for WooCommerce', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'Extra Product Options (Product Addons) for WooCommerce', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'FiboSearch - AJAX Search for WooCommerce', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'innovecouture' ),
			'slug'     => 'woocommerce',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'PW WooCommerce Gift Cards', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'WPC Smart Wishlist for WooCommerce', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'Smash Balloon Social Photo Feed', 'innovecouture' ),
			'slug'     => 'instagram-feed',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'innovecouture' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html( sprintf( __( 'Vamtam Elementor Integration (%s)', 'innovecouture' ), VAMTAM_THEME_SLUG ) ),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'innovecouture' ),
		...
		array(
			'name'     => esc_html( sprintf( __( 'Vamtam Product Q&A', 'innovecouture' ), VAMTAM_THEME_SLUG ) ),
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'innovecouture' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'WooCommerce Payments', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'WooCommerce PayPal Payments', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'innovecouture' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'innovecouture' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'WP Super Cache', 'innovecouture' ),
			'slug'     => 'wp-super-cache',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'innovecouture' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'innovecouture' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'CookieYes | GDPR Cookie Consent & Compliance Notice (CCPA Ready)', 'innovecouture' ),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'innovecouture' ),
		'description' => esc_html__( 'Description', 'innovecouture' ),
		'status'      => esc_html__( 'Status', 'innovecouture' ),
		'version'     => esc_html__( 'Version', 'innovecouture' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'innovecouture' );
	}
	if ( strpos( $plugin['slug'], 'innovecouture' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'innovecouture' );
	}
...
function vamtam_tgmpa_admin_menu_args( $args ) {
	$args['page_title'] = esc_html__( 'Install Plugins', 'innovecouture' );
