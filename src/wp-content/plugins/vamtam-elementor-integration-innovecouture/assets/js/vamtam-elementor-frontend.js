		...
		VamtamPopupsHandler: {
			...
			lateInit: function () {
				setTimeout( () => {
					...
					this.fiboSearchBarWidgetInPopups();
				}, 50 );
			},
			...
			fiboSearchBarWidgetInPopups: function () {
				...
				$( document ).on( 'elementor/popup/show', ( event, id, instance ) => {
					...
					const containsFiboSearchBarWidget = instance.$element.find( '.elementor-widget-fibosearch' ).length;

					if ( ! containsFiboSearchBarWidget ) {
						return;
					}
