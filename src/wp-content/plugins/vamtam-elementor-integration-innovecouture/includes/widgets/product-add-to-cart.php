...
function add_view_cart_section( $controls_manager, $widget ) {
	...
	$widget->add_group_control(
		...
		[
			...
			'selector' => '{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart',
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'size_units' => [ 'px', 'em' ],
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart' => 'color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'type' => $controls_manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart' => 'background-color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'type' => $controls_manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart' => 'border-color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'type' => $controls_manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart:hover' => 'color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'type' => $controls_manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart:hover' => 'background-color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'type' => $controls_manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart:hover' => 'border-color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'selectors' => [
				'{{WRAPPER}} .cart .added_to_cart, {{WRAPPER}} .elementor-widget-container .e-loop-add-to-cart-form-container a.added_to_cart' => 'transition: all {{SIZE}}s !important',
			],
		]
	);
...
function add_custom_variations_controls( $controls_manager, $widget ) {
	...
	$widget->add_control(
		...
		[
			...
			'type' => $controls_manager::COLOR,
			'selectors' => [
				'.woocommerce {{WRAPPER}} .woocommerce-variation .woocommerce-variation-price .price,
				.woocommerce {{WRAPPER}} .vamtam-variation-price .price .amount' => 'color: {{VALUE}}',
			],
		]
	);
	...
	$widget->add_group_control(
		...
		[
			...
			'selector' => '.woocommerce {{WRAPPER}} .woocommerce-variation .woocommerce-variation-price .price, .woocommerce {{WRAPPER}} .vamtam-variation-price .price .amount',
		]
	);
}
