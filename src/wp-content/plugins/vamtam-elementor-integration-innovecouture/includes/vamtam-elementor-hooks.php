...
function enqueue_editor_scripts() {
	...
	$themeCustomColorFontIds = \VamtamElementorBridge::get_theme_custom_color_and_font_ids();

	wp_localize_script(
		'vamtam-elementor', 'VAMTAM_ELEMENTOR_STRINGS', array(
			'customThemeColorRemoveText' => esc_html__( 'Custom Theme Colors can\'t be deleted', 'wpv' ),
			'customThemeFontRemoveText' => esc_html__( 'Custom Theme Fonts can\'t be deleted', 'wpv' ),
			'themeCustomColorIds' => $themeCustomColorFontIds[ 'theme_custom_colors' ],
			'themeCustomFontIds' => $themeCustomColorFontIds[ 'theme_custom_fonts' ],
		)
	);
}
