	...
	\Vamtam_Elementor_Utils::add_control_options( $controls_manager, $kit, 'form_field_focus_border_color', [
		'selectors' => [
			implode( ',', [
				...
				'{{WRAPPER}} .elementor-element.elementor-widget-woocommerce-cart .woocommerce .input-text:hover',
				'{{WRAPPER}} .elementor-element.elementor-widget-woocommerce-checkout-page .woocommerce #customer_details .form-row .input-text:hover',
				'{{WRAPPER}} .elementor-element.elementor-widget-woocommerce-checkout-page.elementor-widget #coupon_code:hover',
				'{{WRAPPER}} .elementor-element.elementor-widget-woocommerce-checkout-page .woocommerce .woocommerce-checkout .e-woocommerce-login-anchor .form-row .input-text:hover',
...
function update_buttons_section_controls( $controls_manager, $kit ) {
	$theme_btn_selectors = [
		...
		'.woocommerce-account .elementor-widget-woocommerce-my-account.vamtam-has-theme-widget-styles .woosw-list .woosw-item--add .vamtam-add-to-cart-wrap :is(.button)',
		'html .elementor-widget-woocommerce-my-account .e-my-account-tab:not(.e-my-account-tab__dashboard--custom) .woocommerce a.button',
	];
