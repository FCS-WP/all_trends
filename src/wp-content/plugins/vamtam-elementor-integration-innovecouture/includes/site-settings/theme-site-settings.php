...
class Settings_Theme_Settings extends Tabs\Tab_Base {
	...
	protected function add_global_underline_anim_controls( $kit ) {
		...
		$kit->add_control(
            ...
            [
                'type' => Controls_manager::RAW_HTML,
                'raw' => __( '<h3>Used in Button / Call To Action</h3>', 'vamtam-elementor-integration' ),
    ...
    protected function add_wc_controls( $kit ) {
		...
		do_action( 'vamtam_theme_settings_wc_controls_after_wc_toggles_registered', $kit );
    }
...
function add_wc_shipping_progress_bar_controls( $kit ) {
	$theme_prefix    = 'vamtam_theme_';
	$prefix          = $theme_prefix . 'wc_spb_';
	$base_conditions = [
		// "{$theme_prefix}disable_all_wc_mods" => '',
		// "{$theme_prefix}enable_all_wc_mods" => '',
		"{$theme_prefix}shipping_progress_bar_theme_mod" => 'yes',
	];
    ...
    //     [
    //         'type' => Controls_manager::HEADING,
    //         'label' => __( 'Shipping Progress Bar', 'vamtam-elementor-integration' ),
    //         'separator' => 'before',
	// 		'condition' => $base_conditions + [ "{$theme_prefix}enable_all_wc_mods" => 'yes' ]
    //     ]
    // );

	// Show on mini cart.
	$kit->add_control(
		"{$prefix}show_on_mini_cart",
		[
			'label' => __( 'Show on Mini Cart', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::SWITCHER,
			'default' => 'yes',
	...
	// Show on cart page.
	$kit->add_control(
		"{$prefix}show_on_cart_page",
		[
			'label' => __( 'Show on Cart Page', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::SWITCHER,
			'default' => 'yes',
			'condition' => $base_conditions,
			'frontent_available' => true,
	...
	$kit->add_control(
		"{$prefix}goal_amount",
		[
			'label' => __( 'Goal Amount', 'vamtam-elementor-integration' ),
	...
	// Include Taxes.
	$kit->add_control(
		"{$prefix}include_taxes",
		[
			'label' => __( 'Include Taxes', 'vamtam-elementor-integration' ),
			'description' => __( 'Calculate subtotal with taxes.', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::SWITCHER,
			'default' => 'yes',
			'condition' => $base_conditions,
			'frontent_available' => true,
	...
	$kit->add_control(
		"{$prefix}initial_msg",
		[
			'label' => __( 'Initial Message', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::TEXTAREA,
			'description' => __( 'Message to show before reaching the goal. Use shortcode [missing_amount] to display the amount left to reach the set goal.', 'vamtam-elementor-integration' ),
			'default' => __( 'Add [missing_amount] more to get Free Shipping!', 'vamtam-elementor-integration' ),
			'condition' => $base_conditions,
			'frontent_available' => true,
		]
	);
	...
	$kit->add_control(
		"{$prefix}success_msg",
		[
			'label' => __( 'Success Message', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::TEXTAREA,
			'description' => __( 'Message to show when the goal is reached.', 'vamtam-elementor-integration' ),
			'default' => __( 'You have free shipping!', 'vamtam-elementor-integration' ),
			'condition' => $base_conditions,
			'frontent_available' => true,
		]
	);
	...
	$kit->add_control(
		"{$prefix}normal_color",
		[
			'label' => __( 'Primary Bar Color', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::COLOR,
			'default' => '#b9a16b',
			'condition' => $base_conditions,
			'frontent_available' => true,
			'selectors' => [
				'.vamtam-free-shipping-progress-bar' => '--vamtam-fspb-color-primary: {{VALUE}}',
			],
		]
	);
	...
	// Progress bar color.
	$kit->add_control(
		"{$prefix}normal_color_remaining",
		[
			'label' => __( 'Remaining Bar Color', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::COLOR,
			'default' => '#0000001a',
			'condition' => $base_conditions,
			'frontent_available' => true,
			'selectors' => [
				'.vamtam-free-shipping-progress-bar' => '--vamtam-fspb-color-remaining: {{VALUE}}',
			],
		]
	);
	...
	$kit->add_control(
		"{$prefix}success_color",
		[
			'label' => __( 'Bar Success Color', 'vamtam-elementor-integration' ),
			'type' => Controls_manager::COLOR,
			'default' => '#67bb67',
			'condition' => $base_conditions,
			'frontent_available' => true,
			'selectors' => [
				'.vamtam-free-shipping-progress-bar' => '--vamtam-fspb-color-success: {{VALUE}}',
			],
		]
	);
}
add_action( 'vamtam_theme_settings_wc_controls_after_wc_toggles_registered', __NAMESPACE__ . '\add_wc_shipping_progress_bar_controls', 10 );
